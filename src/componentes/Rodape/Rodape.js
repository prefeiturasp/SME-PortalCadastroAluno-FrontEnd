                        ...
                        <div className="col-lg-3 col-xs-12">
                            <div className="form-group mb-2">
                                ...
                                >
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/assistencia_social">
                                        Assistência Social
                                    </option>
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/controladoria_geral">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/pessoa_com_deficiencia">
                                        Pessoa com Deficiência
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/procuradoria_geral/">
                                        Procuradoria Geral do Município
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/relacoes_internacionais">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/seguranca_urbana/">
                                        Segurança Urbana
                                    </option>
                            ...
                            <div className="form-group mb-2">
                                ...
                                >
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/regionais/sapopemba/">
                                        Sapopemba
                                    </option>
                            ...
                            <div className="form-group mb-0">
                                ...
                                >
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/licenciamentos/colegiados/index.php?p=148608">
                                        Comissão de Avaliação de Empreendimentos Habitacionais de
                                        Interesse Social –CAEHIS
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/licenciamentos/colegiados/index.php?p=148605">
                                        Comissão de Edificações e Uso do Solo - CEUSO
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/orgaos_colegiados/index.php?p=204">
                                    ...
                                    <option
                                        value="http://transparencia.prefeitura.sp.gov.br/admindireta/empresas/Paginas/SPSEC.aspx">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/pessoa_com_deficiencia/conselho/">
                                        Conselho Municipal da Pessoa com Deficiência - CMPD
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/assistencia_social/comas/">
                                        Conselho Municipal de Assistência Social - COMAS
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/lgbt/conselho/index.php?p=150958">
                                        Conselho Municipal de Atenção à Diversidade Sexual
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/habitacao/organizacao/cmh/index.php?p=139">
                                        Conselho Municipal de Habitação - CMH
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/desenvolvimento_urbano/cmpu/index.php?p=144874">
                                        Conselho Municipal de Política Urbana – CMPU
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/saude/conselho_municipal/">
                                        Conselho Municipal de Saúde - CMS
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/planejamento/cmi/">
                                        Conselho Municipal de Tecnologia de Informação e
                                        Comunicação - CMTIC
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/financas/institucional/index.php?p=3182">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/meio_ambiente/cades/index.php?p=3250">
                                        Conselho Municipal do Meio Ambiente e Desenvolvimento
                                        Sustentável - CADES
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/juventude/conselho/index.php?p=149694">
                                        Conselho Municipal dos Direitos da Juventude
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/direito_a_memoria_e_a_verdade/">
                                        Coordenação de Direito à Memória e à Verdade
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/edh/">
                                        Coordenação de Política sobre Drogas
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/poprua/">
                                        Coordenação de Políticas para a População em Situação de
                                        Rua
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/criancas_e_adolescentes/">
                                        Coordenação de Políticas para Crianças e Adolescentes
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/idosos/">
                                        Coordenação de Políticas para Idosos
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/juventude/">
                                        Coordenação de Políticas para Juventude
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/lgbt/">
                                        Coordenação de Políticas para LGBT
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/migrantes/">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/trabalho/fundacao_paulistana/apresentacao/index.php?p=25342">
                                        Fundação Paulistana de Educação e Tecnologia
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/cultura/noticias/?p=9064">
                                        Fundação Theatro Municipal de São Paulo
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/direitos_humanos/idosos/conselho/">
                                        Grande Conselho Municipal do Idoso
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/seguranca_urbana/guarda_civil/">
                                        Guarda Municipal Metropolitana - GCM
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/saude/hospital_do_servidor_publico_municipal/">
                                        Hospital do Servidor Público Municipal - HSPM
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/saude/hospital_municipal_infantil_menino_jesus/">
                                    ...
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/urbanismo/sp_urbanismo/">
                                        São Paulo Urbanismo - SPUrbanismo
                                    </option>
                                    <option
                                        value="http://www.prefeitura.sp.gov.br/cidade/secretarias/trabalho/abastecimento/">
